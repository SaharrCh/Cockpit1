    ...
    return (
        <div className={styles.suppliers}>
            ...
            <p >
                ...
                <br></br> <span className={styles.Acc}>” </span> Je suis très satisfait de notre collaboration avec Citron®. La plateforme web nous fait
                 gagner du temps grâce à l’automatisation de la collecte et de l’analyse de nos
                  ...
                  Un Energy Manager nous accompagne dorénavant dans le traitement des alertes
                   et dans la définition d’une stratégie énergétique 
                   <br></br> <span className={styles.Acc2}>” </span> </p>
                   
                   <p className={styles.Acc3}> Directeur des achats Groupe d’une grande entreprise française</p>
                   <div className={styles.eclipse}>  </div> <div className={styles.eclipse2}>  </div>  <div className={styles.eclipse2}>  </div>
